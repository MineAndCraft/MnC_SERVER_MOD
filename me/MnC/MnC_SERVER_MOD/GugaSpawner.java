...
{
	public GugaSpawner(MnC_SERVER_MOD plugin, Location loc, int interval)
	{
		this.isRunning = true;
		this.canSpawn = false;
		this.plugin = plugin;
	...
	public GugaSpawner(MnC_SERVER_MOD plugin, Location loc, int interval, int cap, EntityType spawnType)
	{
		this.isRunning = true;
		this.canSpawn = false;
		this.plugin = plugin;
