...
public class InventoryListener implements Listener
{
	...
	public void onInventoryMoveItemEvent(InventoryMoveItemEvent e)
	{
		...
		if(destType == InventoryType.CHEST)
		{
			...
			if(Guga_SERVER_MOD.getInstance().blockLocker.IsLocked(chest.getBlock()))
			{
				e.setCancelled(true);
			}
		}
		else if(destType == InventoryType.FURNACE)
		{
			...
			if(Guga_SERVER_MOD.getInstance().blockLocker.IsLocked(furnace.getBlock()))
			{
				e.setCancelled(true);
			}
		}
		else if(destType == InventoryType.DISPENSER)
		{
			...
			if(Guga_SERVER_MOD.getInstance().blockLocker.IsLocked(dispenser.getBlock()))
			{
				e.setCancelled(true);
			}
		}
