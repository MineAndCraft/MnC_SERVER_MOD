...
public abstract class GugaIPHandler 
{
	public static void SetPlugin(Guga_SERVER_MOD gugaSM)
	{
		plugin = gugaSM;
	}
	public static void AddBan(String playerName, int expiration)
	{
	...
	{
		plugin.log.info("Saving IPlogs file...");
	...
	{
		plugin.log.info("Loading IPlogs file...");
	...
	private static String bansFile = "plugins/IPlog.dat";
}